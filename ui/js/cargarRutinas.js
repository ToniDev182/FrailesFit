                    ...
                    html += `
                      <div class="col">
                        <div class="card h-100">
                          <img src="${ejercicio.imagenUrl || '#'}" class="card-img-top" alt="${ejercicio.nombre || ''}">
                          <div class="card-body">
                            <h5 class="card-title">${ejercicio.nombre || 'Sin nombre'}</h5>
                            <p class="card-text"><strong>Repeticiones:</strong> ${ejercicio.repeticiones || '-'}</p>
                            <p class="card-text"><strong>Observaciones:</strong> ${ejercicio.observaciones || '-'}</p>
                          </div>
                        </div>
                      </div>
                    `;
