                  ...
                  if (rutinaElement) {
                      ...
                      diasOrdenados.forEach(dia => {
                          ...
                          if (ejercicios && ejercicios.length > 0) {
                              ...
                              html += '<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-3">'; // Ajustamos las columnas para ser más pequeñas
                                  ...
                                  html += `
                                    <div class="col">
                                      <div class="card h-100">
                                        ...
                                        <div class="card-body p-2"> <!-- Reducimos el padding de las tarjetas -->
                                          <h5 class="card-title small">${ejercicio.nombre || 'Sin nombre'}</h5> <!-- Reducimos el tamaño del texto -->
